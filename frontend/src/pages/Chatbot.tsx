          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Asisten AI untuk pengelolaan sampah</p>
              </div>
            </div>
            <button
              onClick={clearChat}
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="bg-white border shadow-sm rounded-lg px-4 py-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-600">EcoBot sedang mengetik...</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {messages.length <= 1 && (
            <div className="px-6 pb-4">
              <div className="bg-white rounded-lg border p-4">
                <h3 className="text-sm font-medium text-gray-900 mb-3">Pertanyaan Populer:</h3>
