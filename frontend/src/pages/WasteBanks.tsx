...
import { MapPin, Phone, Clock, Recycle, Navigation, Search, RefreshCw, AlertCircle, Map as MapIcon, Grid3X3 } from 'lucide-react';
...
export const WasteBanks: React.FC = () => {
  ...
  const filteredWasteBanks = wasteBanks
    ...
    .map(bank => ({
      ...
      distance: userLocation 
        ? calculateDistance(userLocation.lat, userLocation.lng, bank.latitude, bank.longitude)
  ...
  const WasteBankCard: React.FC<{ bank: WasteBank & { distance?: number } }> = ({ bank }) => (
      ...
      <div className="p-6">
        ...
        <div>
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-gray-900">Jenis Sampah:</span>
          </div>
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          {bank.createdAt && (
            <span className="text-xs text-gray-400">
              Ditambahkan: {new Date(bank.createdAt).toLocaleDateString('id-ID')}
            </span>
          )}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Temukan bank sampah di sekitar Anda untuk mendaur ulang sampah dengan nilai ekonomis
          </p>
        </div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-green-800">
                Lokasi Anda berhasil dideteksi. Bank sampah diurutkan berdasarkan jarak terdekat.
              </span>
            </div>
          </div>
        ) : (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-yellow-800">
                Izinkan akses lokasi untuk melihat bank sampah terdekat dari Anda.
              </span>
            </div>
          </div>
        )}
                    ...
                    {wasteBanks.length === 0 ? (
                      <>
                        ...
                        <p className="text-gray-600 mb-4">
                          Admin belum menambahkan bank sampah atau terjadi masalah koneksi
                        </p>
                        <button
                          onClick={handleRefresh}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm opacity-90">
                Sampah Anda memiliki nilai jual dan bisa menjadi penghasilan tambahan
              </p>
            </div>
            <div className="text-center">
