      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Upload gambar atau ambil foto sampah untuk mengidentifikasi jenisnya menggunakan AI
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="p-6">
            ...
            >
              {loading ? (
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-500 mb-4">atau pilih salah satu opsi di bawah</p>
            ...
            <div className="mt-8 p-4 bg-blue-50 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">Tips untuk hasil terbaik:</h4>
            ...
            {!user && (
              <div className="mt-6 p-4 bg-yellow-50 rounded-lg">
                <p className="text-yellow-800">
                  <strong>Login</strong> untuk menyimpan hasil klasifikasi dan mengakses fitur premium lainnya.
                </p>
              </div>
            )}
          </div>
